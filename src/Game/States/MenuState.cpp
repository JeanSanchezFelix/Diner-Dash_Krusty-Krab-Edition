...
void MenuState::render() {
	...
	ofDrawBitmapString("Press 'e' to pickup Ingredients", ofGetWidth()/2 - 340 , ofGetHeight()/2 + 250);
	ofDrawBitmapString("Press 'u' to remove Ingredients", ofGetWidth()/2 - 340 , ofGetHeight()/2 + 300);
